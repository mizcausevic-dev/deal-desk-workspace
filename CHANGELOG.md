...
### Released
- Published **deal-desk-workspace** as a public, portfolio-grade identity governance system.
...
### Shipped
- Cut the first coherent internal version of the product shape behind **deal-desk-workspace**.
...
- That insight became the basis for **deal-desk-workspace**.
